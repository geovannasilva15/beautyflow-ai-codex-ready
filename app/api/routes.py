...
from app.db.models import Appointment, Campaign, Client, ConversationMessage, Professional, Service
...
def delete_client(client_id: int, session: Session = Depends(get_session)) -> dict:
    ...
    if has_appointment:
        raise HTTPException(status_code=400, detail="Cliente possui agendamentos vinculados.")
